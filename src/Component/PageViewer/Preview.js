...
class Preview extends Component {
  ...
  updatePreview = () => {
    ...
    /* Splash preview */
    var splashDataSource = "holder.js/" + splashWidth + "x" + splashHeight + "?theme=simple&text=" + appName;
  ...
  render() {
    return (
      <div className={'preview-layout'}>
        <h3>Preview</h3>
        <img data-src={`holder.js/160x160?theme=simple&text= App name`} id="app_icon_preview"
        ...
        <img data-src={`holder.js/320x480?theme=simple&text= App name`} id="app_splash_preview"
